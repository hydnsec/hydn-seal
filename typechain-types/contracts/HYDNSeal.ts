...
export interface HYDNSealInterface extends utils.Interface {
  functions: {
    ...
    "mintSeal(address[])": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "proxiableUUID()": FunctionFragment;
    "reinitialize(string)": FunctionFragment;
...
export interface HYDNSeal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HYDNSealInterface;
